...
ins1 = arr_data[11].rsplit(' ',1)[1]
tbl1 = arr_data[12].rsplit(' ',1)[1]
ins2 = arr_data[14].rsplit(' ',1)[1]
tbl2 = arr_data[15].rsplit(' ',1)[1]
ins3 = arr_data[17].rsplit(' ',1)[1]
tbl3 = arr_data[18].rsplit(' ',1)[1]
ins4 = arr_data[20].rsplit(' ',1)[1]
tbl4 = arr_data[21].rsplit(' ',1)[1]
ins5 = arr_data[23].rsplit(' ',1)[1]
tbl5 = arr_data[24].rsplit(' ',1)[1]
ins6 = arr_data[26].rsplit(' ',1)[1]
tbl6 = arr_data[27].rsplit(' ',1)[1]
ins7 = arr_data[29].rsplit(' ',1)[1]
tbl7 = arr_data[30].rsplit(' ',1)[1]
ins8 = arr_data[32].rsplit(' ',1)[1]
tbl8 = arr_data[33].rsplit(' ',1)[1]
ins9 = arr_data[35].rsplit(' ',1)[1]
tbl9 = arr_data[36].rsplit(' ',1)[1]
ins10 = arr_data[38].rsplit(' ',1)[1]
tbl10 = arr_data[39].rsplit(' ',1)[1]
...
try:
    ...
    client = monitor_client.MonitorClient(cred, "ap-singapore", clientProfile) 
